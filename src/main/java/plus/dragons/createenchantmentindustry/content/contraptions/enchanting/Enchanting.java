...
public class Enchanting {
    ...
    public static Pair<FluidStack, ItemStack> enchant(ItemStack stack, ItemStack targetItem, boolean simulate, boolean hyper) {
        ...
        var resultingFluid = new FluidStack(hyper ? CeiFluids.HYPER_EXPERIENCE.get().getSource() : CeiFluids.EXPERIENCE.get().getSource(), getExperienceFromEnchantment(enchantment));
